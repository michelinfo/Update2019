...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Michel Jesus", "michel@gmail.com", new DateTime(1984, 05, 29), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Costa", "maria@gmail.com", new DateTime(1984, 04, 01), 3500.0, d2);
            Seller s3 = new Seller(3, "Madu Santos", "duda@gmail.com", new DateTime(2017, 04, 23), 2200.0, d1);
            Seller s4 = new Seller(4, "Matheus Duarte", "matheus@gmail.com", new DateTime(2001, 09, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Gabriel Bulhões", "gabriel@gmail.com", new DateTime(2005, 05, 20), 4000.0, d3);
            Seller s6 = new Seller(6, "Mikael Teixeira", "mikael@gmail.com", new DateTime(2011, 05, 02), 3000.0, d2);
